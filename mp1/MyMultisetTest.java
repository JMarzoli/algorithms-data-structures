...
//    }
    ...
    @Test
    public void testIteratorFailSafeAddCount() {
        MyMultiset<Integer> m = new MyMultiset<Integer>();
        m.add(1, 3);
        Iterator<Integer> itr = m.iterator();
    ...
    @Test
    public void testIteratorFailSafeAdd() {
        MyMultiset<Integer> m = new MyMultiset<Integer>();
        m.add(1, 3);
        Iterator<Integer> itr = m.iterator();
        assertTrue(itr.hasNext());
    ...
    @Test
    public void testIteratorFailSafeRemoveCount() {
        MyMultiset<Integer> m = new MyMultiset<Integer>();
        m.add(1, 3);
        Iterator<Integer> itr = m.iterator();
        assertTrue(itr.hasNext());
    ...
    @Test
    public void testIteratorFailSafeRemove() {
        MyMultiset<Integer> m = new MyMultiset<Integer>();
        m.add(1, 1);
        m.add(2, 2);
        Iterator<Integer> itr = m.iterator();
    ...
    @Test
    public void testIteratorFailSafeSetCount() {
        MyMultiset<Integer> m = new MyMultiset<Integer>();
        m.add(1, 5);
        Iterator<Integer> itr = m.iterator();
        assertTrue(itr.hasNext());
    ...
    @Test
    public void testIteratorFailSafeClear() {
        MyMultiset<Integer> m = new MyMultiset<Integer>();
        m.add(1, 5);
        Iterator<Integer> itr = m.iterator();
        assertTrue(itr.hasNext());
